...
public class SinglyLinkedList<E> implements Cloneable {
  ...
  public SinglyLinkedList() {
    // TODO: Correctly construct an empty SinglyLinkedList
  }
  ...
  public boolean isEmpty() {
    // TODO: Determine whether or not the SinglyLinkedList is empty
  }
   ...
   */
  public E getFirst() {
    // TODO: return but do not remove the first node's element
  }
  ...
  public void addLast(E element) {
    // TODO: Add an element at the end of the list
  }
  ...
  public String toString() {
    ...
    // TODO: Use StringBuilder to store the elements that you extract from
    // "walking" (or, "link hopping") the SinglyLinkedList, producing a textual
    // representation of the following form: "(element_1, element_2, ...,
    // element_n)". Please note that there will not be a "..." in your output;
    // this symbol is only used in the previous sentence to indicate that all n
    // elements will be in the textual output that toString() produces.
