...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight/experiment \
                                     --checkfiles Experiment.java --fragments "println(" --fragmentcounts 4
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 2 "public static void" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight/experiment \
                                     --checkfiles Experiment.java --fragments "public static void" --fragmentcounts 2
  determine_exit_code $?
  ...
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 1 "```" fragment exists in the technical writing
  python3 gatorgrader/gatorgrader.py --nowelcome --directories writing \
